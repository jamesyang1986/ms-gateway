...
public class RouteTest3 {
	...
	public void init() throws Exception {
		...
		// 添加路由规则
		rc.addRouteRule("A00*;query", "10.24.1.1:8080");
		rc.addRouteRule("A00*;query", "10.24.1.2:8080");
		rc.addRouteRule("A00*;query", "10.24.1.3:8080");
		rc.addRouteRule("A0*0;query", "10.24.1.3:8080");
