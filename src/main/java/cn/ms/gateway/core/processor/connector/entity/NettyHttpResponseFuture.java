...
import cn.ms.gateway.core.processor.connector.support.NettyHttpResponseBuilder;
...
public class NettyHttpResponseFuture {
	...
	public NettyHttpResponse get() throws InterruptedException,
			ExecutionException {
		latch.await();
		return responseBuilder.build();
	}

	public NettyHttpResponse get(long timeout, TimeUnit unit)
