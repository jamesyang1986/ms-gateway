...
public class RouteContext {
	...
	public static final String SCENEID_KEY = "sceneId";
	//规则分割、匹配符号		
	...
	public RouteContext() {
		...
		routeListSet1.add(URL.valueOf("http://10.24.1.62:29002/AtTran?version=1.0.0&sceneId=S01"));
		routeListSet1.add(URL.valueOf("http://10.24.1.62:29002/AtTran?version=1.0.0&sceneId=S01"));
		this.addRouteList("AtTran", "1.0.0", "S01", routeListSet1);
		//服务atbillquery
		Set<URL> routeListSet2=new HashSet<URL>();
		routeListSet2.add(URL.valueOf("http://10.24.1.62:29001/atbillquery?version=1.0.0&sceneId=S02"));
	 ...
	 * @param routeListSet
	 */
	public void addRouteList(String serviceId, String version, String sceneId, Set<URL> routeListSet) {
